...
//ffdshow
const CLSID GraphUtil::clsid_ffdshow_video_decoder = {0x04FE9017,0xF873,0x87,{0x1E,0xAB,0x91,0x66,0x1A,0x4E,0xF7}};
...
HRESULT GraphUtil::AddToRot( LPCWSTR wszDescription, IUnknown *pUnkGraph, DWORD *pdwRegister )
{
	...
	WCHAR wsz[256];
	//must start with FilterGraph
	swprintf_s(wsz, L"FilterGraph %s(pid:%d)", wszDescription, GetCurrentProcessId());
