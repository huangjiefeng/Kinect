...
public:
	ISampleCaptureGraphBuilder()
	{
		AudPID_ = 0xC0;
		VidPID_ = 0xE0;
		//´´½¨ICaptureGraphBuilder2 capture graphs
		HRESULT hr = CoCreateInstance(CLSID_CaptureGraphBuilder2, NULL, CLSCTX_INPROC_SERVER, IID_ICaptureGraphBuilder2, (void**)&graphBuilder2_ ); 
		ASSERT( S_OK == hr );
	}
